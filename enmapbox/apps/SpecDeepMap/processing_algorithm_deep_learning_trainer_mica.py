...
from enmapbox.apps.SpecDeepMap.core_deep_learning_trainer_mica import dl_train
...
class DL_Trainer(QgsProcessingAlgorithm):
    ...
    def initAlgorithm(self, config=None):
        ...
        self.addParameter(QgsProcessingParameterEnum(
            ...
            options=['imagenet', 'None', 'Sentinel_2_TOA_Resnet18', 'Sentinel_2_TOA_Resnet50','MicaSense_SR_Swin_s3_tiny'], defaultValue=0))
        self.addParameter(
